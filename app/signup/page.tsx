        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-md">
            <Card className="border-gold-dark/30 bg-card/50 backdrop-blur">
              <CardHeader>
                <CardTitle className="text-center text-2xl text-gold">Create Account</CardTitle>
                <p className="text-center text-sm text-muted-foreground">Start tracking your earnings today</p>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="confirm-password" className="text-gold">
                      Confirm Password
                    </Label>
                    <Input
                      id="confirm-password"
