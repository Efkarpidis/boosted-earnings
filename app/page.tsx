    ...
    <div className="min-h-screen bg-black">
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
            <Card className="bg-card/50 backdrop-blur-sm border-gold/20">
              <CardContent className="p-6">
                ...
                <Button type="submit" className="w-full bg-gold hover:bg-gold-dark text-black font-semibold glow-gold">
                  Get Early Access
                </Button>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-black to-card">
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 text-gold">Why Boosted Earnings?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-card/50 backdrop-blur-sm border-gold/20 hover:border-gold/50 transition-all hover:glow-gold">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gold">Real-Time Tracking</h3>
                <p className="text-muted-foreground">
                  Monitor your earnings across all platforms in real-time with intelligent analytics.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-gold/20 hover:border-gold/50 transition-all hover:glow-gold">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gold">Smart Insights</h3>
                <p className="text-muted-foreground">
                  Get actionable insights to maximize your earnings and optimize your driving strategy.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-gold/20 hover:border-gold/50 transition-all hover:glow-gold">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gold">Secure & Private</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-gold/20 hover:border-gold/50 transition-all hover:glow-gold">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gold">Multi-Platform Support</h3>
                <p className="text-muted-foreground">
                  Connect Uber, Lyft, DoorDash, and more. All your earnings in one place.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-gold/20 hover:border-gold/50 transition-all hover:glow-gold">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gold">Instant Notifications</h3>
                <p className="text-muted-foreground">
                  Get alerts for peak hours, surge pricing, and earning opportunities in your area.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-gold/20 hover:border-gold/50 transition-all hover:glow-gold">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gold">Driver Community</h3>
                <p className="text-muted-foreground">
                  Join thousands of drivers sharing tips, strategies, and success stories.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <h2 className="text-4xl font-bold mb-6 text-gold">Maximize Your Earnings</h2>
            ...
            <div className="relative h-96 rounded-lg overflow-hidden border border-gold/20">
              <Image src="/rideshare-earnings-dashboard-with-charts.jpg" alt="Earnings Dashboard" fill className="object-cover" />
            </div>
          </div>

          {/* Reality Section */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative h-96 rounded-lg overflow-hidden border border-gold/20 order-2 md:order-1">
              <Image src="/driver-using-smartphone-in-car.jpg" alt="Driver Reality" fill className="object-cover" />
            </div>
            <div className="order-1 md:order-2">
              <h2 className="text-4xl font-bold mb-6 text-gold">Built by Drivers, for Drivers</h2>
              <p className="text-lg text-muted-foreground mb-6">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-black to-card">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6 text-gold">Ready to Get Started?</h2>
              <p className="text-lg text-muted-foreground mb-8">
                Join our beta program and be among the first to experience the future of rideshare earnings tracking.
                Limited spots available.
              </p>
              <Button className="bg-gold hover:bg-gold-dark text-black font-semibold text-lg px-8 py-6 glow-gold">
                Join Beta Program
              </Button>
            </div>
            <div className="relative h-96 rounded-lg overflow-hidden border border-gold/20">
